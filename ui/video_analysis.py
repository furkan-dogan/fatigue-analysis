...
def _render_real_sensor_tab(
    ...
    """Gerçek EMG+NIRS CSV yükleme, senkron ve görselleştirme. Gerçek veri yüklüyse True döner."""
    import tempfile
    ...
    st.subheader("Gerçek Sensör Verisi — EMG + NIRS")
    st.caption(
        "K-Myo / Delsys EMG ve Moxy NIRS cihazlarından alınan CSV çıktılarını yükleyin. "
        "Sistem tekme zamanlarıyla eşleştirir ve Sporcu Raporu'na entegre eder."
    )
...
def render() -> None:
    ...
    tabs = st.tabs([
        ...
        "🧪 Sensör Simülasyonu", "📡 Gerçek Sensör", "📄 Sporcu Raporu",
    ])
